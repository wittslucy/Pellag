...
DROP DATABASE IF EXISTS blogsite; DROP DATABASE IF EXISTS blog_site;
...
INSERT INTO comment (post_id, comment_content, date_created, last_update, user_id) 
    VALUES 
        (1, 'I am a test comment', curdate(), curdate(), 1);
